...
void test_combined_all_options(test_context& ctx)
{
    ...
    else if (!option1 || option13 != "qmqqqq")
    {
        ctx.errors++;
        std::cout << ERROR_TEXT "Error parsing options " << option_str
            << " not all options are true\r\n";
